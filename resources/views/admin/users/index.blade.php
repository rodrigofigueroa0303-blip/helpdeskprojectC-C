        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="card p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 animate-fade-in">
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-0.5">Gestione las cuentas de usuario y los roles de acceso global del sistema Helpdesk.</p>
                </div>
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="btn-secondary btn-md">Volver al Dashboard</a>
                </div>
            </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-600">
                                ...
                                <tbody class="divide-y divide-gray-100 bg-white">
                                    @forelse($users as $u)
                                        <tr class="table-row">
                                            <td class="table-cell font-medium text-gray-400 text-center text-xs">{{ $u->id }}</td>
                                            ...
                                            <td class="table-cell text-xs text-gray-400">{{ optional($u->created_at)->format('d-m-Y H:i') }}</td>
