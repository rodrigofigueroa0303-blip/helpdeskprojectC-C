        ...
        <tr>
            <td align="center">
                <table width="640" cellpadding="0" cellspacing="0" role="presentation" class="mail-container">
                    ...
                    <tr>
                        <td class="mail-content">
                            <h1 class="mail-title">Nuevo Ticket - Helpdesk C&amp;C</h1>

                            <p>Se ha creado un nuevo ticket en el Helpdesk.</p>

                            <div class="meta-box" style="margin-top:16px;margin-bottom:16px;">
                                <p><span class="meta-label">Asunto:</span> {{ $ticket->subject }}</p>
                                @if($ticket->department)
                                    <p><span class="meta-label">Departamento:</span> {{ $ticket->department }}</p>
                                @endif
                                <p><span class="meta-label">Prioridad:</span> {{ $ticket->priority }}</p>
                                <p>
                ...
                <div class="mail-footer">
                    ...
                    Este mensaje se generan automaticamente, por favor no responder directamente.
                </div>
            </td>
        </tr>
    </table>
